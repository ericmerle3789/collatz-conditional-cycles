...
## -B/C: Partial proofs of EventualDescent
...
### Axiom Hierarchy (+, corrected Cycle 63)
...
/-!
## 3e. EventualDescent for n ≡ 7 mod 128 ()
...
/-!
## 3f. EventualDescent for n ≡ 15 mod 128 ()
...
/-!
## 3h. EventualDescent for 5-step sub-classes ( continued)
...
/-!
## 3j. EventualDescent for mod 512 sub-classes ( continued)
...
/-!
## 3l. mod 1024 proofs (6-step descent)
...
Each covers 1/128 of class 7. Combined with :
...
: first mod-1024 proofs with 6-step chains!
-/
...
PROVED (0 sorry, 0 axiom) — /P10 additions marked with [P9]/[P10]:
