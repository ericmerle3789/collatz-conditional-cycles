...
/-!
# Phase6Lemmas.lean — Nouveaux lemmes Phase 6 (-A)

Lemmes A5–A8 du plan Phase 6 certifié par la the project review.
...
C'est la base de l'analyse par sous-domaines modulaires dans le -C.
-/
