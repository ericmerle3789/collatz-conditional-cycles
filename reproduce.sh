#!/usr/bin/env bash
# reproduce.sh — end-to-end verification of collatz-conditional-cycles
...
#
# Usage :
#   cd /path/to/collatz-conditional-cycles
#   bash reproduce.sh [--from-source]
#
# Convention: exit codes match the project's reproducibility baseline.
