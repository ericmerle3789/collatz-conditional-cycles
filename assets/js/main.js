...
ER  - `;
  ...
  function renderMeaCulpa() {
    ...
    const items = dict === 'fr' ? [
      ...
      , { id: '#29', sev: '5', title: 'papers/index.html presented Salikhov 2007 and Wu 2003 as equivalent for k ≤ 3732', rule: 'Verify exact k_max of each Diophantine bound before presenting multiple papers as equivalent. Salikhov 2007 closes k ≤ 3693 (μ=5.125 asymptotic but effective constant too large) ; Wu 2003 closes k ≤ 3732 (c=5.117 effective). <strong>Formal follow-up</strong>: <a href="https://github.com/ericmerle3789/collatz-conditional-cycles/tree/study/E1-salikhov-2007-impossibility" target="_blank" rel="noopener">δ11 Salikhov-Insufficient-for-3732</a> (Phase 65, kernel-3 + 2 transparent ad-hoc axioms).' }
