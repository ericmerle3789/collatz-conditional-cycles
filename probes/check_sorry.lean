...
and auxiliary theorems audited by the reproducibility baseline. Stricter than textual `grep
...
Coverage extension (2026-04-22): coverage extended from 1 theorem
