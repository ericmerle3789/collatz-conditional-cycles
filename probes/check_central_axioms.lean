...
theorems of `collatz-conditional-cycles`. Runs as part of `reproduce.sh` step [4/5].
...
-- are NOT part of the central theorem's Lean chain at the current baseline (structure is
