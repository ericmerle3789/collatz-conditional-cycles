# Proof Chain — Conditional No-Cycle Theorem

This file documents the dependency graph of the central theorem
`no_nontrivial_cycle_phase59` (and its alias chain) under
Mathlib v4.27.0. It is intended as a navigation aid, complementary
to the paper's §3 (proof chain in informal prose) and §8 (per-file
axiom profile).
